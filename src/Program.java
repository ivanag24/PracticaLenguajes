...
public class Program {
    ...
    public void functions(){
        String s="<h2>Funciones</h2>\n"+
                "<ul>\n"+
                "<A href=\"#PROGRAMA_PRINCIPAL:Main\"><li>Programa Principal</li></A>\n";
        if(!functions.isEmpty()) {
            for (Function f : functions) {
                s=s+"<A href=\"#FUNCIONES:"+f.getIden()+"\"><li>"+f.getCabecera()+"</li></A>\n";
            }
        }
        s=s+"</ul>\n<hr/>";
        write(s);
    ...
    public void writeFunctions(){
        ...
        for (Function f: functions) {
            s = "<div>" + f.getCabeceraHTML() + "</div>\n" +
                    ...
                    "</div>\n" +
                    "<div>}</div>\n" +
                    "<div><A href=\"#FUNCIONES:"+f.getIden()+"\">Inicio de la funcion</A> <A href=\"#Inicio\">Inicio del programa</A></div>\n" +
                    "<hr/>";
            write(s);
        }
    }
    public void writeMain(){
        String s="<A name=\"PROGRAMA_PRINCIPAL:Main\"><h2>Programa principal</h2></A>\n"+globales+
                "<br>"+
                ...
                "</div>\n"+
                "<div>}</div>\n"+
                "<div><A href=\"#PROGRAMA_PRINCIPAL:Main\">Inicio del programa principal</A> <A href=\"#Inicio\">Inicio del programa</A></div>\n"+
                "<hr/>";
        write(s);
    }
